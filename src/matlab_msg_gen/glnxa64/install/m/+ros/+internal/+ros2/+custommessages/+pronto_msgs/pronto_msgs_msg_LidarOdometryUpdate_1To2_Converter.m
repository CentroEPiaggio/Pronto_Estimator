function ros2msg = pronto_msgs_msg_LidarOdometryUpdate_1To2_Converter(message,ros2msg)
%pronto_msgs_msg_LidarOdometryUpdate_1To2_Converter passes data of ROS message to ROS 2 message.
