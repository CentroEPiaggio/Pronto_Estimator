function ros1msg = pronto_msgs_msg_VisualOdometryUpdate_2To1_Converter(message,ros1msg)
%pronto_msgs_msg_VisualOdometryUpdate_2To1_Converter passes data of ROS 2 message to ROS message.
...
ros1msg.EstimateStatus = message.estimate_status;
end