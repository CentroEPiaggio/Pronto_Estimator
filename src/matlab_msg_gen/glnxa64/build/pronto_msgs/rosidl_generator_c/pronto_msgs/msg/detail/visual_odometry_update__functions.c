...
{
  pronto_msgs__msg__VisualOdometryUpdate * msg = (pronto_msgs__msg__VisualOdometryUpdate *)malloc(sizeof(pronto_msgs__msg__VisualOdometryUpdate));
  if (!msg) {
    return NULL;
  }
...
pronto_msgs__msg__VisualOdometryUpdate__Sequence__init(pronto_msgs__msg__VisualOdometryUpdate__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (pronto_msgs__msg__VisualOdometryUpdate *)calloc(size, sizeof(pronto_msgs__msg__VisualOdometryUpdate));
    if (!data) {
      return false;
    }
...
{
  pronto_msgs__msg__VisualOdometryUpdate__Sequence * array = (pronto_msgs__msg__VisualOdometryUpdate__Sequence *)malloc(sizeof(pronto_msgs__msg__VisualOdometryUpdate__Sequence));
  if (!array) {
    return NULL;
  }
