...
static size_t _JointStateWithAcceleration__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_pronto_msgs__msg__JointStateWithAcceleration(
    full_bounded, 0);
}
