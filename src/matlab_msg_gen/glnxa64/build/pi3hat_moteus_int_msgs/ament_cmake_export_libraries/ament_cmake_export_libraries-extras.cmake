...
set(_exported_libraries "pi3hat_moteus_int_msgs__rosidl_generator_c;pi3hat_moteus_int_msgs__rosidl_typesupport_c;pi3hat_moteus_int_msgs__rosidl_typesupport_cpp;pi3hat_moteus_int_msgs_matlab")
...
if(NOT _exported_library_names STREQUAL "")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING "Package 'pi3hat_moteus_int_msgs' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND pi3hat_moteus_int_msgs_LIBRARIES ${_cfg} "${_lib}")
