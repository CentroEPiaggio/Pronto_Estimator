  ...
  void * untyped_ros_message)
{
  ...
  // Field name: kp_scale
  {
    ...
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->kp_scale, size)) {
      return "failed to create array for field 'kp_scale'";
    }
    auto array_ptr = ros_message->kp_scale.data;
    cdr.deserializeArray(array_ptr, size);
  }
  ...
  // Field name: kd_scale
  {
    ...
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->kd_scale, size)) {
      return "failed to create array for field 'kd_scale'";
    }
    auto array_ptr = ros_message->kd_scale.data;
    cdr.deserializeArray(array_ptr, size);
  }
...
static size_t _JointsCommand__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_pi3hat_moteus_int_msgs__msg__JointsCommand(
    full_bounded, 0);
}
