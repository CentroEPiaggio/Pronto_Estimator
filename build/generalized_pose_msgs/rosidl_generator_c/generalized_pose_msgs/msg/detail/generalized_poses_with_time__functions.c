...
generalized_pose_msgs__msg__GeneralizedPosesWithTime__init(generalized_pose_msgs__msg__GeneralizedPosesWithTime * msg)
{
  ...
  if (!generalized_pose_msgs__msg__GeneralizedPoseWithTime__Sequence__init(&msg->generalized_poses_with_time, 0)) {
    generalized_pose_msgs__msg__GeneralizedPosesWithTime__fini(msg);
    return false;
  }
  return true;
}
...
generalized_pose_msgs__msg__GeneralizedPosesWithTime__fini(generalized_pose_msgs__msg__GeneralizedPosesWithTime * msg)
{
  ...
  // generalized_poses_with_time
  generalized_pose_msgs__msg__GeneralizedPoseWithTime__Sequence__fini(&msg->generalized_poses_with_time);
}
...
generalized_pose_msgs__msg__GeneralizedPosesWithTime__are_equal(const generalized_pose_msgs__msg__GeneralizedPosesWithTime * lhs, const generalized_pose_msgs__msg__GeneralizedPosesWithTime * rhs)
{
  ...
  // generalized_poses_with_time
  if (!generalized_pose_msgs__msg__GeneralizedPoseWithTime__Sequence__are_equal(
      &(lhs->generalized_poses_with_time), &(rhs->generalized_poses_with_time)))
  {
    return false;
  }
  return true;
  ...
  generalized_pose_msgs__msg__GeneralizedPosesWithTime * output)
{
  ...
  // generalized_poses_with_time
  if (!generalized_pose_msgs__msg__GeneralizedPoseWithTime__Sequence__copy(
      &(input->generalized_poses_with_time), &(output->generalized_poses_with_time)))
  {
    return false;
  }
  return true;
...
generalized_pose_msgs__msg__GeneralizedPosesWithTime__create()
{
  ...
  generalized_pose_msgs__msg__GeneralizedPosesWithTime * msg = (generalized_pose_msgs__msg__GeneralizedPosesWithTime *)allocator.allocate(sizeof(generalized_pose_msgs__msg__GeneralizedPosesWithTime), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(generalized_pose_msgs__msg__GeneralizedPosesWithTime));
  bool success = generalized_pose_msgs__msg__GeneralizedPosesWithTime__init(msg);
  if (!success) {
...
generalized_pose_msgs__msg__GeneralizedPosesWithTime__Sequence__init(generalized_pose_msgs__msg__GeneralizedPosesWithTime__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  generalized_pose_msgs__msg__GeneralizedPosesWithTime * data = NULL;

  if (size) {
    data = (generalized_pose_msgs__msg__GeneralizedPosesWithTime *)allocator.zero_allocate(size, sizeof(generalized_pose_msgs__msg__GeneralizedPosesWithTime), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = generalized_pose_msgs__msg__GeneralizedPosesWithTime__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        generalized_pose_msgs__msg__GeneralizedPosesWithTime__fini(&data[i - 1]);
      }
...
generalized_pose_msgs__msg__GeneralizedPosesWithTime__Sequence__fini(generalized_pose_msgs__msg__GeneralizedPosesWithTime__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      generalized_pose_msgs__msg__GeneralizedPosesWithTime__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  generalized_pose_msgs__msg__GeneralizedPosesWithTime__Sequence * array = (generalized_pose_msgs__msg__GeneralizedPosesWithTime__Sequence *)allocator.allocate(sizeof(generalized_pose_msgs__msg__GeneralizedPosesWithTime__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = generalized_pose_msgs__msg__GeneralizedPosesWithTime__Sequence__init(array, size);
  if (!success) {
...
generalized_pose_msgs__msg__GeneralizedPosesWithTime__Sequence__destroy(generalized_pose_msgs__msg__GeneralizedPosesWithTime__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    generalized_pose_msgs__msg__GeneralizedPosesWithTime__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
generalized_pose_msgs__msg__GeneralizedPosesWithTime__Sequence__are_equal(const generalized_pose_msgs__msg__GeneralizedPosesWithTime__Sequence * lhs, const generalized_pose_msgs__msg__GeneralizedPosesWithTime__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!generalized_pose_msgs__msg__GeneralizedPosesWithTime__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  generalized_pose_msgs__msg__GeneralizedPosesWithTime__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(generalized_pose_msgs__msg__GeneralizedPosesWithTime);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    generalized_pose_msgs__msg__GeneralizedPosesWithTime * data =
      (generalized_pose_msgs__msg__GeneralizedPosesWithTime *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!generalized_pose_msgs__msg__GeneralizedPosesWithTime__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          generalized_pose_msgs__msg__GeneralizedPosesWithTime__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!generalized_pose_msgs__msg__GeneralizedPosesWithTime__copy(
