...
static const _GeneralizedPoseWithTime_type_support_symbol_names_t _GeneralizedPoseWithTime_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, generalized_pose_msgs, msg, GeneralizedPoseWithTime)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, generalized_pose_msgs, msg, GeneralizedPoseWithTime)),
  }
};
...
{
  return &::generalized_pose_msgs::msg::rosidl_typesupport_cpp::GeneralizedPoseWithTime_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, generalized_pose_msgs, msg, GeneralizedPoseWithTime)() {
  return get_message_type_support_handle<generalized_pose_msgs::msg::GeneralizedPoseWithTime>();
}
