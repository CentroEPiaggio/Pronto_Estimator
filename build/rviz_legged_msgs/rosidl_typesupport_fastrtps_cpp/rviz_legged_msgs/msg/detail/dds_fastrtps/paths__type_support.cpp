...
#include "rviz_legged_msgs/msg/detail/paths__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rviz_legged_msgs::msg::Paths & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rviz_legged_msgs::msg::Paths & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rviz_legged_msgs::msg::Paths;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rviz_legged_msgs::msg::Paths *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rviz_legged_msgs::msg::Paths *>(
    untyped_ros_message);
...
{
  return &rviz_legged_msgs::msg::typesupport_fastrtps_cpp::_Paths__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rviz_legged_msgs, msg, Paths)() {
  return &rviz_legged_msgs::msg::typesupport_fastrtps_cpp::_Paths__handle;
}
