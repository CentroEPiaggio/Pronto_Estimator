...
#include "rviz_legged_msgs/msg/detail/paths__rosidl_typesupport_fastrtps_c.h"
...
using _Paths__ros_msg_type = rviz_legged_msgs__msg__Paths;
...
size_t get_serialized_size_rviz_legged_msgs__msg__Paths(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Paths__ros_msg_type * ros_message = static_cast<const _Paths__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Paths__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rviz_legged_msgs__msg__Paths(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rviz_legged_msgs
size_t max_serialized_size_rviz_legged_msgs__msg__Paths(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rviz_legged_msgs__msg__Paths;
    is_plain =
      (
...
static size_t _Paths__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rviz_legged_msgs__msg__Paths(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rviz_legged_msgs, msg, Paths)() {
