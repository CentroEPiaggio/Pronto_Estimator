...
bool rviz_legged_msgs__msg__paths__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rviz_legged_msgs.msg._paths.Paths", full_classname_dest, 33) == 0);
  }
  rviz_legged_msgs__msg__Paths * ros_message = _ros_message;
  {  // header
...
PyObject * rviz_legged_msgs__msg__paths__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rviz_legged_msgs.msg._paths");
