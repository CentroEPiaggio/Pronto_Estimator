...
static const _SimpleVelocityCommand_type_support_symbol_names_t _SimpleVelocityCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, velocity_command_msgs, msg, SimpleVelocityCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, velocity_command_msgs, msg, SimpleVelocityCommand)),
  }
};
...
{
  return &::velocity_command_msgs::msg::rosidl_typesupport_cpp::SimpleVelocityCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, velocity_command_msgs, msg, SimpleVelocityCommand)() {
  return get_message_type_support_handle<velocity_command_msgs::msg::SimpleVelocityCommand>();
}
